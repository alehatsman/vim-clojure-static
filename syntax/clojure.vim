...
execute 'syntax keyword' 'clojureDefine' join(s:clojure_syntax_keywords['clojureDefine'], ' ') 'nextgroup=clojureDefineName skipwhite'
syntax match clojureDefineName "\v%([a-zA-Z!$&*_+=|<.>?-]|[^\x00-\x7F])+%(:?%([a-zA-Z0-9!#$%&*_+=|'<.>/?-]|[^\x00-\x7F]))*[#:]@<!" contained
